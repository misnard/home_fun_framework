<?php
    ...
    use Application\Controller\PrevController;
    ...
    $articles = $ArticlesDb->fetchAll('', 'DATECREATIONARTICLE DESC',5);
    $a_specials = $ArticlesDb->fetchAll('SPECIALARTICLE = 1', '', '', '');
    $check_prev = new PrevController();
?>
<!DOCTYPE html>
<html lang="en">
<head>
